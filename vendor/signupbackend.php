...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO users (FirstName, LastName, Gender, MaritalStatus, DateOfBirth, Email, PhoneNumber, Password, ConfirmPassword, UserType) 
            VALUES ('$firstName', '$lastName', '$gender', '$maritalStatus', '$dateOfBirth', '$email', '$phoneNumber', '$hashed_password', '$confirmPassword', '$userType')";
